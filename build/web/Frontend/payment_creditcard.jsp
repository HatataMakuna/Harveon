...
<html>
    ...
    <style>
        ...
        .left-box{
            ...
            width: 40%;
            height: 85%;
            background: url('../picture/creditCard.jpg') no-repeat center;
            border-radius: 20px;
            padding-top:40px;
            margin-top:40px;
            margin-right: 30px;
            ...
            <form class="carddetails" action="../payment_validateCreditCard" method="POST">
                ...
                <div class="right-box">
                    ...
                    <div class="details">
                        ...
                        <input type="text" id="cardnumber" name="cardnumber" placeholder="xxxxxxxxxxxx" required><br><br>
                        ...
                        <input type="text" name="cvv" id="cvv" placeholder="xxx" required><br><br>
