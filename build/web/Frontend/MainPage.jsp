...
<html>
    ...
    <body>
        ...
        <header style="background-color:#0A0A0A;">
            ...
            <div class="d-flex" style="background-image:url('../picture/banner1.jpg');width:100%;height: 600px;background-repeat:no-repeat;background-size: cover;">
            ...
            <section class="d-flex" style="justify-content:flex-end">
                <div class="d-flex flex-row" style="height:250px;width:70%;background-color: #08020B;padding:1%;">
                    ...
                    <div class="col-lg-6 m-50" style="height:100%;background-image:url('../picture/banner3.jpg');background-repeat: no-repeat;background-size:contain;background-position-x:right"></div>
                </div>
            </section>
            <br>
            <section>
                ...
                <div class="text-center" style="background-color:#E5E5E5">
                    ...
                    <div class="d-flex flex-row">
                        <div class="logo" style="background-image: url('../picture/Dyson-Logo.png')"></div>
                        <div class="logo" style="background-image: url('../picture/HP-Logo.png')"></div>
                        <div class="logo" style="background-image: url('../picture/Samsung-Logo.png')"></div>
                        <div class="logo" style="background-image: url('../picture/Microsoft-Logo.png')"></div>
                        <div class="logo" style="background-image: url('../picture/Lenovo-Logo.png')"></div>
                    </div>
                </div>
            </section>
            <br>
            <section class="d-flex" style="justify-content:flex-start">
                <div class="d-flex flex-row" style="height:250px;width:70%;background-color: #08020B;padding:1%;">
                    <div class="col-lg-6 m-50" style="height:100%;background-image:url('../picture/banner4.jpg');background-repeat: no-repeat;background-size:contain;background-position-x:left"></div>
