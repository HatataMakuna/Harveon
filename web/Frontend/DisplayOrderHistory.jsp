        ...
        <div style="margin-left:50px; margin-right:50px;">
            ...
            <div id="d<%=dlist%>" name="<%=dlist%>" style="width: 26%; float: left; padding: 20px; display: none; position:fixed; top:10; right:85px;">
                ...
                <table style="width: 100%; background-color:rgba(204,204,204);">
                    ...
                    <tr>
                         <% if (orderProduct.getStatus().equals("Packaging")||orderProduct.getStatus().equals("Shipping")){%>
                         <td colspan="2"><div style="margin-left: 60px; height:30px"><button onclick="showDialog(this.id)" id="<%=username%>" name="<%=prodID%>" style="width:230px" disabled>Comment this product</button></div></td>           
                          <%} else {%>         
